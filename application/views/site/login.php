        ...
        <div class="content">
            ...
            <?php echo form_open('site/login'); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" id="username" value="soporte@inacayal.com.ar" /> </div>
                <div class="form-group">
